...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    emailjs.sendForm(EMAIL_SERVICE_ID, EMAIL_TEMPLATE_ID, e.target, EMAIL_USER_ID)
      .then((result) => {
        ...
        <form onSubmit={handleSubmit}>
          <div className="m-20 flex">
            <div className="ml-20 w-1/2">
              ...
              <input name='name' className="bg-transparent border-b w-[90%] text-slate-300" />
            </div>
            <div className="w-1/2">
              <label className="text-slate-300 text-2xl">Email * </label>
              <input name="email" className="bg-transparent border-b w-[90%] text-slate-300" />
            </div>
          </div>
          <div className="ml-36 w-1/2">
            <label className="text-slate-300 text-2xl">Message * </label>
            <textarea name='message' className="bg-transparent border-b w-full" />
          </div>
          <div className="text-center w-full my-20">
            <button type="submit" className="inline-block text-[#06c6c6] border border-[#06c6c6] px-16 py-2 hover:bg-[#06c6c6] hover:text-[#34383d]">
              Submit
            </button>
          </div>
        </form>
